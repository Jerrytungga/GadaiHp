...
include 'sidebar.php';
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT transaksi.*, barang_gadai.nama_barang FROM transaksi JOIN barang_gadai ON transaksi.barang_id = barang_gadai.id WHERE barang_id = '$id'");
