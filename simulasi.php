...
if(isset($_POST['harga'])){
    ...
    $persentase = 20;  // Persentase yang diinginkan (10%)
    ...
    echo '<tr><th scope="row">Biaya Jasa Bulanan 20%: Rp ' . number_format($diskon, 0, ',', '.') . '</th></tr>';
    ...
    echo '<tr class="bg-success text-light"><th scope="row">Uang yang di kembalikan peminjam: Rp ' . number_format($uang_diterima, 0, ',', '.') . '</th></tr>';
    echo '</tbody>';
    echo '</table>';
}
?>
