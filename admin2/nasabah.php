        ...
        <div class="col-md-4">
          ...
          <div class="card bg-light">
            <div class="card-body text-center">
              ...
              <p class="card-text"><span class="badge badge-custom">KTP:</span> <?= htmlspecialchars($data['ktp_nasabah']) ?></p>
        ...
        <div class="col-md-8">
          <div class="card bg-light">
            <div class="card-body">
              ...
              <p class="card-text"><span class="badge badge-custom">Alamat:</span> <?= htmlspecialchars($data['alamat']) ?></p>
              <p class="card-text"><span class="badge badge-custom">No. Telepon:</span> <?= htmlspecialchars($data['no_hp']) ?></p>
              <h5 class="card-title mt-4">Data HP yang Digadaikan</h5>
              <p class="card-text"><span class="badge badge-custom">Merek & Tipe HP:</span> <?= htmlspecialchars($data['merek_tipe_hp']) ?></p>
              <p class="card-text"><span class="badge badge-custom">Nomor IMEI:</span> <?= htmlspecialchars($data['imei_hp']) ?></p>
              <p class="card-text"><span class="badge badge-custom">Kondisi HP:</span> <?= htmlspecialchars($data['kondisi_hp']) ?></p>
              <p class="card-text"><span class="badge badge-custom">Akses Akun:</span> <?= htmlspecialchars($data['akun_hp']) ?></p>
              <p class="card-text"><span class="badge badge-custom">Kelengkapan HP:</span> <?= htmlspecialchars($data['kelengkapan_hp']) ?></p>
              <div class="row">
                <div class="col-md-4">
              ...
              <p class="card-text"><span class="badge badge-custom">Tanggal Jatuh Tempo:</span> <?= htmlspecialchars($data['tanggal_jatuh_tempo']) ?></p>
